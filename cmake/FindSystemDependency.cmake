...
function(find_system_dependency NAME)
    ...
    if(${NAME} STREQUAL "thread_system")
        list(APPEND POSSIBLE_TARGETS thread_system utilities ThreadSystem)
    elseif(${NAME} STREQUAL "logger_system")
        list(APPEND POSSIBLE_TARGETS logger_system logger LoggerSystem)
    elseif(${NAME} STREQUAL "container_system")
        list(APPEND POSSIBLE_TARGETS container_system container ContainerSystem::container)
    ...
    elseif(${NAME} STREQUAL "network_system")
        list(APPEND POSSIBLE_TARGETS network_system network NetworkSystem)
    elseif(${NAME} STREQUAL "database_system")
        list(APPEND POSSIBLE_TARGETS database_system database)
