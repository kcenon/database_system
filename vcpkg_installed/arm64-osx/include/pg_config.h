...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/Users/dongcheolshin/Sources/messaging_system/build/vcpkg_installed/arm64-osx' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/usr/bin/cc  -fPIC -g -DNDEBUG -fPIC -O3' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/Users/dongcheolshin/Sources/messaging_system/build/vcpkg_installed/arm64-osx/lib -L/Users/dongcheolshin/Sources/messaging_system/build/vcpkg_installed/arm64-osx/lib/manual-link' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/opt/homebrew/bin/pkg-config' 'PKG_CONFIG_PATH=/Users/dongcheolshin/vcpkg/packages/libpq_arm64-osx/lib/pkgconfig:/Users/dongcheolshin/vcpkg/packages/libpq_arm64-osx/share/pkgconfig:/Users/dongcheolshin/Sources/messaging_system/build/vcpkg_installed/arm64-osx/lib/pkgconfig:/Users/dongcheolshin/Sources/messaging_system/build/vcpkg_installed/arm64-osx/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.9 on aarch64-apple-darwin25.0.0, compiled by Apple clang version 17.0.0 (clang-1700.0.13.5), 64-bit"
